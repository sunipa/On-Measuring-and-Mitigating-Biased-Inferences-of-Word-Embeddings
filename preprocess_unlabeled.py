...
def main(arguments):
	...
	parser.add_argument('--sent1', help="Path to sent1 extra data.", default = "")
	parser.add_argument('--sent2', help="Path to sent2 extra data.", default = "")
	parser.add_argument('--label', help="Path to label data (optional)", default = "")
	parser.add_argument('--dir', help="Path to the data dir",default = "./data/bert_bias/")	

	parser.add_argument('--vocab', help="Path to the glove vocabulary preprocessed", default = "./data/bert_bias/snli.word.dict")
	parser.add_argument('--vocab_all', help="Path to the all word vocabulary preprocessed", default = "./data/bert_bias/snli.allword.dict")
