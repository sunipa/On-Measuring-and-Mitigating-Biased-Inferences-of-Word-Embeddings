...
def main(arguments):
	...
	parser.add_argument('--sent1_val', help="Path to sent1 validation data.",default = "dev.raw.sent1.txt")
	parser.add_argument('--sent2_val', help="Path to sent2 validation data.", default = "dev.raw.sent2.txt")
